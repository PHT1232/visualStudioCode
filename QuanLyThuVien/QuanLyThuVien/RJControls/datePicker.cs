...
namespace QuanLyThuVien.RJControls
{
    public class datePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.baseline_calendar_month_black_24dp;
        private RectangleF iconButtonArea;
        private const int calendarIconWidth = 34;
        private const int arrowIconWidth = 30;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.baseline_calendar_month_black_24dp;
                else calendarIcon = Properties.Resources.baseline_calendar_month_white_24dp;
                this.Invalidate();
            }
        }
